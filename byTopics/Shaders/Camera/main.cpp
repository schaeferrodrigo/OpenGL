...
#define WINDOW_HEIGHT 480 
 ...
 struct Camera{
    ...
    glm::vec3 position = glm::vec3(1.f, 0.0f, 1.f);
...
void Display() {
    ...
    glUniformMatrix4fv(glGetUniformLocation(myFirstCompiledProgram[0],"viewMatrix"),1,GL_FALSE, glm::value_ptr(viewMatrix));
